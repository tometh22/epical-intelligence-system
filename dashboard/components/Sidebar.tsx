...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-zinc-700/50 bg-zinc-900">
      <div className="flex h-16 items-center gap-3 border-b border-zinc-700/50 px-6">
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-600 text-sm font-bold text-white">
          E
        </div>
        <div>
          <span className="text-base font-semibold text-zinc-100">Epical</span>
          <span className="ml-1 text-xs text-zinc-500">Intelligence</span>
        </div>
      </div>
